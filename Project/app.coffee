...
# 	print "yay"
	Selected.x = 275 + 32 * Pages.horizontalPageIndex(Pages.currentPage)

# Shrink the indicator when moving
Pages.content.on Events.DragMove, ->
	Selected.animate
		properties: { scale: 0 }
		time: 0.1
		opacity: 0.1

# Expand it back up when the drag is finished
Pages.content.on Events.DragEnd, ->
	Selected.animate
...
# Modulating the planets and background when swiping through pages
	...
	artboardF.blur = Utils.modulate this.x, [-3139, -3750], [5, 0], true
